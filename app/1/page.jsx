export default function Home() {
  return (
    <>
      <div className="flex bg-gray-200 flex-row w-[750px] mx-auto rounded-lg border border-gray-200  text-gray-950 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50">
